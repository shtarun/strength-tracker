...
final class ProgressUITests: XCTestCase {
    ...
    func testProgress_ShowsOverviewTab() throws {
        ...
        let overviewExists = app.buttons["Overview"].waitForExistence(timeout: 3) ||
    ...
    func testProgress_ShowsLiftsTab() throws {
        ...
        let liftsExists = app.buttons["Lifts"].waitForExistence(timeout: 3) ||
    ...
    func testProgress_ShowsCalendarTab() throws {
        ...
        let calendarExists = app.buttons["Calendar"].waitForExistence(timeout: 3) ||
    ...
    func testProgress_ShowsWeeklyStats() throws {
        ...
        let weeklyExists = app.staticTexts.element(matching: NSPredicate(format: "label CONTAINS[c] 'week' OR label CONTAINS[c] 'weekly'")).waitForExistence(timeout: 3)
    }
    ...
    func testProgress_ShowsStreakInfo() throws {
        ...
        let streakExists = app.staticTexts.element(matching: NSPredicate(format: "label CONTAINS[c] 'streak'")).waitForExistence(timeout: 3)
    }
    ...
    func testProgress_ShowsPRs() throws {
        ...
        let prExists = app.staticTexts.element(matching: NSPredicate(format: "label CONTAINS[c] 'PR' OR label CONTAINS[c] 'personal record' OR label CONTAINS[c] 'best'")).waitForExistence(timeout: 3)
    }
    ...
    func testProgress_ShowsVolumeChart() throws {
        ...
        let volumeExists = app.staticTexts.element(matching: NSPredicate(format: "label CONTAINS[c] 'volume'")).waitForExistence(timeout: 3)
    }
    ...
    func testProgress_CalendarShowsWorkoutDays() throws {
        ...
        if calendarTab.waitForExistence(timeout: 3) {
            ...
            // Calendar typically shows month/days
        }
    }
    ...
    func testProgress_ExerciseDetailShowsHistory() throws {
        ...
        if firstExercise.waitForExistence(timeout: 3) {
            ...
            let historyExists = app.staticTexts["History"].waitForExistence(timeout: 3) ||
    ...
    func testProgress_ExerciseDetailShowsFormTips() throws {
        ...
        if firstExercise.waitForExistence(timeout: 3) {
            ...
            let infoButton = app.buttons.element(matching: NSPredicate(format: "label CONTAINS[c] 'info' OR label CONTAINS[c] 'form'"))
            
            let hasFormTips = formTips.waitForExistence(timeout: 3) ||
    ...
    func testProgress_ShowsMuscleGroupBreakdown() throws {
        ...
        let muscleExists = app.staticTexts.element(matching: NSPredicate(format: "label CONTAINS[c] 'muscle' OR label CONTAINS[c] 'chest' OR label CONTAINS[c] 'back' OR label CONTAINS[c] 'legs'")).waitForExistence(timeout: 5)
    }
